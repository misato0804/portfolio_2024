    ...
    <section className='max-w-[1280px] mx-auto p-12 md:p-24 lg:p-32'>
      <div className='md:grid grid-cols-3 my-24'>
        <div className='relative flex justify-center items-center my-24'>
          ...
          <h2 ref={titleRef} className='font-bold font-display absolute text-center items-center flex justify-center text-2xl'>
            {sectionTitle}
          </h2>
        </div>
        <div className="flex items-center w-full col-span-2">
          <p ref={paragraghRef} className='my-4 md:my-0 text-[1.4rem]'>{description}</p>
        </div>
      </div>
      <div ref={childRef}>
        {children}
